        ...
        <div className="max-w-xs   ">
          ...
          <ul className="py-8 space-y-2">
            <li className="flex text-slate-500 text-sm">
              <AiOutlineHeart className="my-1  mr-4 text-xl text-rose-600" />2
              hours of professional in-person consultation
            </li>
            <li className="flex text-slate-500 text-sm">
          ...
          <Link to={"/"}>
            <button className="btn border-secondary rounded-sm hover:btn-secondary text-secondary bg-white">
              Purchase
            </button>
          </Link>
        </div>
