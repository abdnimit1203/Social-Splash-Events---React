const Planning = () => {
  return (
    <div >
      {/* start */}
      <h2 className="w-full text-center text-2xl md:text-4xl font-bold py-16  text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
      ...
      data-aos-duration="500" className="relative flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md border py-10 mx-auto ">
          ...
          <div className="p-6 pt-0">
            <button
              className="block mx-auto rounded-full select-none bg-blue-gray-900/10 py-3 px-6 text-center align-middle border w-fit font-semibold text-primary border-primary transition duration-300 ease-in-out hover:scale-110"
              type="button"
            >
              Get Started
            </button>
